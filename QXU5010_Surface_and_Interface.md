...
**Note** 'Interface' is used where the two phases are named explicitly, like 'sureface of solid' $\rightarrow$ 'solid/gas interface'.
...
**Note**: The phospholipid chemical structure is not required for the exam.
...
**Note**: There is no solvent in the centre of the micelle structure.
...
**Note**: The better the solvent is, the more extended polymer is. 
